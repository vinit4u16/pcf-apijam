...
1. Login to Apigee, through Apigee's SSO
    ...
    ```
   curl -X POST https://login.apigee.com/oauth/token -H 'authorization: Basic ZWRnZWNsaTplZGdlY2xpc2VjcmV0' -H 'content-type: application/x-www-form-urlencoded' -d 'username=sandeepmuru%2Bpivotal%2Blabuser9%40google.com&password=Apigee123&grant_type=password'
