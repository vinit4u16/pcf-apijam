...
Apigee Edge API Proxy created in earlier lab exercise. If not, jump back to "Lab 1 - API Design, Developement - Build a microservice on PCF from an OpenAPI Specification" lab.
...
3. Click on cf-**{your_initials}**-employees-api.**{your_pcf_app_domain}**. This API Proxy would have been created by Apigee's Service Broker for PCF in the previous lab
